...
;(() => {
        ...
        e.exports = (function e(t, n, i) {
          function r(a, o) {
            if (!n[a]) {
              if (!t[a]) {
                if (s) return s(a, !0)
                let c = new Error("Cannot find module '" + a + "'")
              ...
              function (e, t, n) {
                  ...
                  if (
                    ((r.filename = (function (e, t) {
                      ...
                      if (o && o.length)
                        ...
                        !r && typeof t.includer != 'function')
                      )
                        throw new Error('Could not find the include file "' + t.escapeFunction(e) + '"')
                      return r
                    })(e, r)),
                    typeof t.includer == 'function')
                  ) {
                    let a = t.includer(e, r.filename)
                ...
                ;(n.cache = s.cache),
                  ...
                  (n.render = function (e, t, n) {
                    let i = t || {},
                      r = n || {}
                    return arguments.length == 2 && s.shallowCopyFromList(r, i, l), m(r, e)(i)
                  }),
                  (n.renderFile = function () {
                    let e,
                      ...
                      a = { filename: r }
                    return (
                      typeof arguments[arguments.length - 1] == 'function' && (e = i.pop()),
                      i.length
                        ? ((t = i.shift()),
                          i.length
                  ...
                  (x.prototype = {
                      ...
                      let m = i.client
                        ...
                        : function (e) {
                            return t.apply(i.context, [
                              ...
                              c,
                              function (t, n) {
                                let r = s.shallowCopy({}, e)
                                return n && (r = s.shallowCopy(r, n)), v(t, i)(r)
                              },
                              g,
                            ])
                          }
                      if (i.filename && typeof Object.defineProperty == 'function') {
                        let p = i.filename,
                          f = r.basename(p, r.extname(p))
                        try {
                          Object.defineProperty(m, 'name', { value: f, writable: !1, enumerable: !1, configurable: !0 })
                        } catch (e) {}
                      }
                      return m
                    },
                    ...
                    parseTemplateText() {
                      for (var e, t = this.templateText, n = this.regex, i = n.exec(t), r = []; i; )
                        (e = i.index) !== 0 && (r.push(t.substring(0, e)), (t = t.slice(e))),
                          r.push(i[0]),
                      ...
                      switch (((t = e.split('\n').length - 1), e)) {
                        ...
                        case '_' + n + r:
                          this.mode == x.modes.LITERAL && this._addOutput(e),
                            (this.mode = null),
                            (this.truncate = e.indexOf('-') === 0 || e.indexOf('_') === 0)
                          break
                        default:
                          if (this.mode) {
                            switch (this.mode) {
                  ...
                  (n.VERSION = o),
                  (n.name = 'ejs'),
                  typeof window != 'undefined' && (window.ejs = n)
              },
            ...
            2: [
              function (e, t, n) {
                ...
                ;(n.escapeXML = function (e) {
                  return e == null ? '' : String(e).replace(s, a)
                }),
                ...
                ;(function (e) {
                  ...
                  ;(n.resolve = function () {
                    ...
                    (n.dirname = function (e) {
                      ...
                      for (var t = e.charCodeAt(0), n = t === 47, i = -1, r = !0, s = e.length - 1; s >= 1; --s)
                    ...
                    (n.extname = function (e) {
                      ...
                      return t === -1 || i === -1 || s === 0 || (s === 1 && t === i - 1 && t === n + 1)
                        ? ''
                        : e.slice(t, i)
                    })
            ...
            5: [
              function (e, t, n) {
                ...
                ;(s.nextTick = function (e) {
                  ...
                  d.push(new f(e, t)), d.length !== 1 || u || c(p)
                }),
  ...
  ;(n.n = (e) => {
    ...
    (n.d = (e, t) => {
      for (let i in t) n.o(t, i) && !n.o(e, i) && Object.defineProperty(e, i, { enumerable: !0, get: t[i] })
    }),
